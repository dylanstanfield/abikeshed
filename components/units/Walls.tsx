...
export const Walls: React.FC<{ signText?: string }> = ({ signText }) => (
  <group>
    {/* South */}
    ...
    <Position x={2.8} y={0.5} z={1.25} rotate={{ y: 90 }}>
      ...
      <Position x={1.25} y={2.11} z={0.1} rotate={{ z: 3 }}>
        <Box height={0.3} width={2} depth={0.1} color={"#3d3c38"} />
        <Position z={0.051}>
          <Text
            color={"#ffffff"}
            maxWidth={8}
